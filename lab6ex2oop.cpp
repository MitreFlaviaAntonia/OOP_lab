...
static void afisare(double n){
    cout<<"Numar real: "<<n<<endl;
}

static void afisare(NumarComplex ob){
    cout<<"Numar complex: "<<ob.parteaReala<<"+("<<ob.parteaImaginara<<")*i"<<endl;
}

static double calculateModule(NumarComplex ob){
    static double moduleComplex;
    moduleComplex=sqrt(ob.parteaReala*ob.parteaReala+ob.parteaImaginara*ob.parteaImaginara);
    return moduleComplex;
}

static double calculateModule(double z){
    static double moduleDouble;
