...
static NumarComplex1 AddComplex(NumarComplex1 ob1,NumarComplex2 ob2){
    double SumR,SumI;
...
static NumarComplex1 SubstractComplex(NumarComplex1 ob1,NumarComplex2 ob2){
...
static NumarComplex1 MultiplyComplex(NumarComplex1 ob1,NumarComplex2 ob2){
...
static NumarComplex2 DivideComplex(NumarComplex1 ob1,NumarComplex2 ob2){
    double DivR,DivI;
...
static double SubstractDouble(double x,double y){
    double Dif;
